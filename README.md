...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/black-rain-65ba#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/black-rain-65ba
```

A live public deployment of this template is available at [https://black-rain-65ba.templates.workers.dev](https://black-rain-65ba.templates.workers.dev)
